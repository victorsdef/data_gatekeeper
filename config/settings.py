...
LDAPSEARCH_BIN = os.getenv("LDAPSEARCH_BIN", "ldapsearch")
LDAP_BIND_TEMPLATE = os.getenv("LDAP_BIND_TEMPLATE", "{username}@{domain}")
LDAP_SEARCH_BIND_DN = os.getenv("LDAP_SEARCH_BIND_DN", "")
LDAP_SEARCH_BIND_PASSWORD = os.getenv("LDAP_SEARCH_BIND_PASSWORD", "")
